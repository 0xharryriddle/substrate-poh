...
// --output
// pallets/poh/src/weights.rs
// --template
// ../../.maintain/frame-weight-pallet_poh.hbs
...
/// Weight functions needed for pallet_poh.
pub trait WeightInfo {
	fn do_something() -> Weight;
	fn cause_error() -> Weight;
}

/// Weights for pallet_poh using the Substrate node and recommended hardware.
#[cfg_attr(
    not(feature = "std"),
    deprecated(
