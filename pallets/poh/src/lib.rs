...
//!
//! The Substrate Proof of History Pallet provides a Proof of History mechanism for a Substrate-based
//! Blockchain. It enables 
//!
//! ## Overview
//!
//! The PoH pallet implements a On-chain Clock that is used to provide a Proof of History mechanism
